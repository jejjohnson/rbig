...
### 2. Modern Python Idioms (Python >= 3.10)
...
- Flat layout enforced (`rbig/` at project root)
...
- Prefer vectorized numpy/scipy operations over Python loops for numerical work
